  ...
  return (
    <div ref={containerRef} className={`w-full mx-auto py-6 ${textColor}`}>
      ...
      <div className="flex flex-col items-center space-y-6 md:space-y-8">
        ...
        <div
          className={`flex flex-col sm:flex-row items-center ${accentColor} px-4 sm:px-5 py-4 rounded-lg animate-section border-b`}
        >
        ...
        <div
          ref={statsRef}
          className="grid grid-cols-2 lg:grid-cols-4 gap-3 w-full animate-section"
        >
          {/* Stats Cards - 2 columns on mobile, 4 columns on lg */}
          {/* Row 1, Col 1 */}
          <div
            className={`stat-card ${bgColor} p-3 rounded-lg border ${borderColor} transition-all duration-300 shadow-sm flex flex-col`}
          >
